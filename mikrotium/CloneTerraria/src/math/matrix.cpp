...
void Camera(float Xmin, float Xmax, float Ymin, float Ymax, float* matrix4x4f)
{
...
void Transform(float x, float y, float* matrix4x4f)
{
...
void Scale(float x, float y, float* matrix4x4f)
{
